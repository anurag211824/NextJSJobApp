...
import { MapPin, Building, DollarSign, Clock, Briefcase, Users } from 'lucide-react';
...
const Jobgrid = ({ jobs }) => {
  ...
  return (
    <div className="max-w-[1300px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {jobs.map((job) => (
        <Card key={job.id} className="hover:shadow-lg transition-all h-auto duration-300 hover:-translate-y-1 border-l-4 border-l-primary/20 hover:border-l-primary">
